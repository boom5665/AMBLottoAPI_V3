  ...
  <div>
        ...
        <div class="btn-toolbar mb-3" role="toolbar">
          <div class="form-group col-12">
            <label set-lan="html:When a player">
              ...
              ระบบจะส่งคำขอเพื่อรับยอดเงินคงเหลือของผู้เล่นจริง</label
            >
          </div>
    ...
    <span class="hljs-attr">"data"</span>: {
        ...
        <span class="hljs-attr">"agentUsername"</span>: <span class="hljs-string">"comptestseamless"</span>
          ...
          <div class="form-group col-12 ex">
            <lable
              ><b style="color: #19a17a !important" set-lan="text:Request Code"
                >Response Code</b
              >
            </lable>
          </div>
              ...
              >
                <thead class="rgba-green-slight">
                  <tr>
                    ...
                    <th set-lan="html:Type" class="thcolor bRight txtCenter">
                      Description
                    </th>
                  </tr>
                </thead>
    ...
    <span class="hljs-attr">"balance"</span>: <span class="hljs-number">880</span>
        ...
        <div class="col-12" id="tabSeven">
          <lable
            ><b
              style="color: #19a17a !important"
              set-lan="text:4.5.2 UserPlaceBet"
              >4.5.3
              ...
              >
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="bRight">
                      If government = true is lottoset, If government = false is
                      lotto.
                    </td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td class="bRight">Number</td>
                    <td class="bRight">
                      Position tracking (%) of api(Askmelotto).
                    </td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td class="bRight">
                      User bet type =
                      top6,top5,top4,top3,top2,top1,row4,row3,row2,bottom3,bottom2,bottom1
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td class="bRight">Number</td>
                    <td class="bRight">
                      If 0=rate payout normal, If =1, 2, 3, 4 rate discount.
                    </td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td class="bRight">String</td>
                    <td class="bRight">
                      Success (Payment สำเร็จ), Pending (รอผล), Cancel(ยกเลิก).
                    </td>
                  </tr>
                  <tr>
    ...
    <span class="hljs-attr">"code"</span>: <span class="hljs-number">0</span>
        ...
        <div class="col-12" id="tabEight">
          <lable
            ><b style="color: #19a17a !important"
              >4.5.4
              <span style="padding-left: 3px" id="Seamless_UserPlaceBetCancel"
        ...
        <div class="btn-toolbar mb-3" role="toolbar">
          <div class="form-group col-12">
            <label set-lan="html:when previous PlaceBet">
              ...
              2.2 กรณียกเลิกทีละเลข Status ของตั๋วจะเป็นสถานะของตั๋วนั้น
              ซึ่งรายละเอียดในการเดิมพันของรายการที่ต้องการยกเลิกจะมี
              ...
              >
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="bRight">Number</td>
                    <td class="bRight">
                      totalPayOutAmt equals 0 when a player loses.
                    </td>
                  </tr>
                  <tr>
                    <td class="bRight">txtList</td>
                  ...
                  <tr>
                    ...
                    <td class="bRight">Number</td>
                    <td class="bRight">
                      Rate payout when member win.(*recheck and update for
                      lottoset.)
                    </td>
                  </tr>
                  <tr>
                ...
                <div class="koh-faq-question form-group ex">
                  <lable class="Point">
                    <b
                      ...
                      <span style="color: red">(กรณีไม่ถูกรางวัล)</span></b
                    >
