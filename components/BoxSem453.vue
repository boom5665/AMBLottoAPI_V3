  ...
  <div style="">
    <div type="primary" class="box-r-scoll">
      ...
      <div class="col-12" id="tabSeven" style="margin-bottom: 25px">
        <div>
          <b style="color: #19a17a !important" set-lan="text:4.5.3 UserPlaceBet"
            >4.5.3
      ...
      <div class="koh-faq-answer col-12">
        <copy-text id="myDiv">
          <pre>
<code id="352A" style="border-radius: 0.375rem;  height: 300px; overflow: scroll;" class="hljs json">{
 ...
 <span class="hljs-attr">"data"</span>: {
     ...
     <span class="hljs-attr">"ticketId"</span>: <span class="hljs-string">4168027</span>,
     ...
     <span class="hljs-attr">"drawId"</span>: <span class="hljs-string">71884</span>,
     <span class="hljs-attr">"totalBetAmt"</span>: <span class="hljs-string">-15.92</span>,
     <span class="hljs-attr">"drawName"</span>: <span class="hljs-string">"Stock German"</span>,
     ...
     <span class="hljs-attr">"txtList"</span>: [
            {
             ...
             <span class="hljs-attr">"betKey"</span>: <span class="hljs-string">"NDE2ODAyNy0x"</span>,
             <span class="hljs-attr">"betId"</span>: <span class="hljs-string">"1"</span>,
             <span class="hljs-attr">"betType"</span>: <span class="hljs-string">"top2"</span>,
             <span class="hljs-attr">"betNumber"</span>: <span class="hljs-string">"18"</span>,
             <span class="hljs-attr">"betStatus"</span>: <span class="hljs-string">"pending"</span>,
             <span class="hljs-attr">"betAmt"</span>: <span class="hljs-string">1.98</span>,
             <span class="hljs-attr">"betTotal"</span>: <span class="hljs-string">2</span>,
            ...
            },
            {
             <span class="hljs-attr">"agentPt"</span>: <span class="hljs-string">"0"</span>,
             <span class="hljs-attr">"apiPt"</span>: <span class="hljs-string">"100"</span>,
             <span class="hljs-attr">"betKey"</span>: <span class="hljs-string">"NDE2ODAyNy0y"</span>,
             <span class="hljs-attr">"betId"</span>: <span class="hljs-string">"2"</span>,
             <span class="hljs-attr">"betType"</span>: <span class="hljs-string">"top2"</span>,
             <span class="hljs-attr">"betNumber"</span>: <span class="hljs-string">"81"</span>,
             <span class="hljs-attr">"betStatus"</span>: <span class="hljs-string">"pending"</span>,
             <span class="hljs-attr">"betAmt"</span>: <span class="hljs-string">1.98</span>,
             <span class="hljs-attr">"betTotal"</span>: <span class="hljs-string">2</span>,
             <span class="hljs-attr">"betDiscount"</span>: <span class="hljs-string">1</span>,
            ...
            },
            {
             <span class="hljs-attr">"agentPt"</span>: <span class="hljs-string">"0"</span>,
             <span class="hljs-attr">"apiPt"</span>: <span class="hljs-string">"100"</span>,
             <span class="hljs-attr">"betKey"</span>: <span class="hljs-string">"NDE2ODAyNy0z"</span>,
             ...
             <span class="hljs-attr">"betNumber"</span>: <span class="hljs-string">"18"</span>,
             <span class="hljs-attr">"betStatus"</span>: <span class="hljs-string">"pending"</span>,
             <span class="hljs-attr">"betAmt"</span>: <span class="hljs-string">2</span>,
             <span class="hljs-attr">"betTotal"</span>: <span class="hljs-string">2</span>,
            ...
            },
            {
             <span class="hljs-attr">"agentPt"</span>: <span class="hljs-string">"0"</span>,
             <span class="hljs-attr">"apiPt"</span>: <span class="hljs-string">"100"</span>,
             <span class="hljs-attr">"betKey"</span>: <span class="hljs-string">"NDE2ODAyNy00"</span>,
            ...
            },
            {
             <span class="hljs-attr">"agentPt"</span>: <span class="hljs-string">"0"</span>,
             <span class="hljs-attr">"apiPt"</span>: <span class="hljs-string">"100"</span>,
             <span class="hljs-attr">"betKey"</span>: <span class="hljs-string">"NDE2ODAyNy01"</span>,
            ...
            },
            {
             <span class="hljs-attr">"agentPt"</span>: <span class="hljs-string">"0"</span>,
             <span class="hljs-attr">"apiPt"</span>: <span class="hljs-string">"100"</span>,
             <span class="hljs-attr">"betKey"</span>: <span class="hljs-string">"NDE2ODAyNy02"</span>,
            ...
            },
            {
             <span class="hljs-attr">"agentPt"</span>: <span class="hljs-string">"0"</span>,
             <span class="hljs-attr">"apiPt"</span>: <span class="hljs-string">"100"</span>,
             <span class="hljs-attr">"betKey"</span>: <span class="hljs-string">"NDE2ODAyNy03"</span>,
            ...
            },
            {
             <span class="hljs-attr">"agentPt"</span>: <span class="hljs-string">"0"</span>,
             <span class="hljs-attr">"apiPt"</span>: <span class="hljs-string">"100"</span>,
             <span class="hljs-attr">"betKey"</span>: <span class="hljs-string">"NDE2ODAyNy04"</span>,
     ...
     <span class="hljs-attr">"createDate"</span>: <span class="hljs-string">"2024-05-09 17:15:28"</span>,
     <span class="hljs-attr">"ip"</span>: <span class="hljs-string">"2001:fb1:3d:fa3:1d9a:fc11:3bd1:6a75"</span>,
  ...
  mounted() {
    ...
    const json = {
      ...
      data: {
        ...
        status: "pending",
        createDate: "2024-05-09 17:15:28",
        ip: "2001:fb1:3d:fa3:1d9a:fc11:3bd1:6a75",
        currency: "thb",
