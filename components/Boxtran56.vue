    ...
    <div type="primary" class="box-r-scoll">
      ...
      <div class="divBox">
        ...
        <div class="col-12">
          ...
          <label> https://test-api.askmelotto.com/apiRoute/api/withdraw </label>
        </div>
        <div class="col-12">
...
export default {
  ...
  data() {
    return {
      ...
      URLdata: "https://test-api.askmelotto.com/apiRoute/api/withdraw", // กำหนดค่าเริ่มต้นของ agentUsername
      code: "",
      addBalance: "",
      afterAgentBalance: "",
      afterMemberBalance: "",
