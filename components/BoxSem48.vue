  ...
  <div style="">
    <div type="primary" class="box-r-scoll">
      ...
      <div class="col-12" id="tabSeven">
        <div>
          <b style="color: #19a17a !important" set-lan="text:4.7 Detail"
            >4.7
      ...
      <div class="divBox">
        ...
        <div class="col-12">
          ...
          <label> https://test-api.askmelotto.vip/apiRoute/api/detail </label>
        </div>
        <div class="col-12">
...
export default {
  ...
  data() {
    return {
      ...
      URLdata: " https://test-api.askmelotto.vip/apiRoute/api/detail", // กำหนดค่าเริ่มต้นของ agentUsername
      // agentUsername: "",
      // agentApiKey: "",
      // services: "",
    };
  ...
  methods: {
    closeAndClear() {
      ...
      // this.jsonData = '';
      this.URLdata = "https://test-api.askmelotto.vip/apiRoute/api/detail";
