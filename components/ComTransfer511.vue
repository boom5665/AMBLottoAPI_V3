              ...
              <table class="table table-borderless table-striped" id="DataTable47A">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>{{ $t("tran510_req_agentUsername") }}</td>
                  </tr>

                  <tr>
                    <td class="bRight">agentApiKey</td>
                    <td class="bRight">String</td>
                    <td>{{ $t("tran510_req_agentApiKey") }}</td>
                  </tr>

                  <tr>
                    <td class="bRight">ref</td>
                    <td class="bRight">String</td>
                    <td>{{ $t("tran510_req_ref") }}</td>
                  </tr>
                </tbody>
              </table>
            </div>
              ...
              <table class="table table-borderless table-striped" id="DataTable47B">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>{{ $t("tran510_res_code") }}</td>
                  </tr>

                  <tr>
                    <td class="bRight">data</td>
                    <td class="bRight">Object</td>
                    <td>{{ $t("tran510_res_data") }}</td>
                  </tr>

                  <tr>
                    <td class="bRight">data.playerApiId</td>
                    <td class="bRight">String</td>
                    <td>{{ $t("tran510_res_data_playerApiId") }}</td>
                  </tr>

                  <tr>
                    <td class="bRight">data.playerApiUsername</td>
                    <td class="bRight">String</td>
                    <td>{{ $t("tran510_res_data_playerApiUsername") }}</td>
                  </tr>

                  <tr>
                    <td class="bRight">data.playerUsername</td>
                    <td class="bRight">String</td>
                    <td>{{ $t("tran510_res_data_playerUsername") }}</td>
                  </tr>

                  <tr>
                    <td class="bRight">data.ref</td>
                    <td class="bRight">String</td>
                    <td>{{ $t("tran510_res_data_ref") }}</td>
                  </tr>

                  <tr>
                    <td class="bRight">data.transferAmount</td>
                    <td class="bRight">Number</td>
                    <td>{{ $t("tran510_res_data_transferAmount") }}</td>
                  </tr>

                  <tr>
                    <td class="bRight">data.transferDate</td>
                    <td class="bRight">String</td>
                    <td>{{ $t("tran510_res_data_transferDate") }}</td>
                  </tr>

                  <tr>
                    <td class="bRight">data.type</td>
                    <td class="bRight">String</td>
                    <td>{{ $t("tran510_res_data_type") }}</td>
                  </tr>

                  <tr>
                    <td class="bRight">msg</td>
                    <td class="bRight">Object</td>
                    <td>{{ $t("tran510_res_msg") }}</td>
                  </tr>

                  <tr>
                    <td class="bRight">msg.en</td>
                    <td class="bRight">String</td>
                    <td>{{ $t("tran510_res_msg_en") }}</td>
                  </tr>

                  <tr>
                    <td class="bRight">msg.th</td>
                    <td class="bRight">String</td>
                    <td>{{ $t("tran510_res_msg_th") }}</td>
                  </tr>
              ...
              <table class="table table-borderless table-striped" id="DataTable47C">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>{{ $t("tran510_err_71020") }}</td>
                  </tr>

                  <tr>
                    <td class="bRight">71031</td>
                    <td>{{ $t("tran510_err_71031") }}</td>
                  </tr>
                </tbody>
              </table>
            </div>
