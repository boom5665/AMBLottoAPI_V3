  ...
  <div class="box-sem">
    <div class="col-12">
      <div class="box-version">
        <div class="col-12">
          <div>
            <div class="font-prim">3. <span>Lotto Type </span></div>
          </div>
          <div>
            <div class="font-prim" id="3.2">3.1 <span>Key Type </span></div>
          </div>
        </div>
        <div class="col-12">
          <div class="table-wrapper" style="width: 100%">
            ...
            >
              <thead class="rgba-green-slight">
                <tr>
                  <th class="thcolor bRight txtCenter">No.</th>
                  <th class="thcolor bRight txtCenter">Key</th>
                  <th class="thcolor txtCenter">Description</th>
                  <th class="thcolor txtCenter">Subtype</th>
                  <th class="thcolor txtCenter">Government</th>
                </tr>
              </thead>
              <tbody>
                <tr>
                  ...
                  <td class="bRight">
                    top6,top5,top4,row4,top3,bottom3,row3,top2,bottom2,row2,top1,bottom1
                  </td>
                ...
                <tr>
                  ...
                  <td class="bRight">
                    รวบหวยหุ้น(ใช้ประเภทนี้ในการตั้งค่าเท่านั้น)
                  </td>
                  <td class="bRight">top3,row3,top2,bottom2,top1,bottom1</td>
                  <td class="txtCenter">ไทย</td>
                </tr>
                ...
                <tr>
                  ...
                  <td class="bRight">
                    row2,row3,top1,top2,top3,bottom1,bottom2
                  </td>
                  <td class="txtCenter">ไทย</td>
                </tr>
                <tr>
                  ...
                  <td class="bRight">
                    row2,row3,row4,top1,top2,top3,top4,top5,top6,bottom1,bottom2
                  </td>
                  <td class="txtCenter">ไทย</td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td class="bRight">
                    row2,row3,row4,top1,top2,top3,top4,top5,bottom1,bottom2
                  </td>
                  <td class="txtCenter">ไทย</td>
                </tr>
                <tr>
