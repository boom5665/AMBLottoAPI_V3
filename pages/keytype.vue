    ...
    <div class="col-12">
      <div class="box-version">
        <div class="col-12" id="tabTwo">
          <div>
            <div class="font-prim">3.2 <span>Key Sub Type </span></div>
          </div>
          ...
          >
            ...
            <tbody>
              ...
              <tr>
                <td class="bRight txtCenter">16</td>
                <td class="bRight">ball1</td>
                <td class="bRight">บอล 1</td>
              </tr>
              <tr>
                <td class="bRight txtCenter">17</td>
                <td class="bRight">ball2</td>
                <td class="bRight">บอล 2</td>
              </tr>
              <tr>
                <td class="bRight txtCenter">18</td>
                <td class="bRight">ball3</td>
                <td class="bRight">บอล 3</td>
              </tr>
              <tr>
                <td class="bRight txtCenter">19</td>
                <td class="bRight">ball4</td>
                <td class="bRight">บอล 4</td>
              </tr>
              <tr>
                <td class="bRight txtCenter">19</td>
                <td class="bRight">color</td>
                <td class="bRight">สี</td>
              </tr>
            </tbody>
          </table>
        </div>
